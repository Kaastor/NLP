...
what words determine what category. 
'''
...
vocab_size = 2500
embedding_dim = 16  # embedding per word
max_length = 120  # 25
trunc_type = 'post'
padding_type = 'post'
oov_tok = '<OOV>'
...
with open("./data/bbc-text.csv", 'r') as csvfile:
    ...
    for row in reader:
        labels.append(row[0])
        sentence = row[1]
        # removing stop words is preprocessing step in NLP
...
print("Sequences validation_sequences")
...
label_tokenizer = Tokenizer(oov_token=oov_tok)
